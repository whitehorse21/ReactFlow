    ...
    >
      ...
      >
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Box component={RouterLink} to="/" sx={{ display: 'inline-flex', paddingLeft: '20px' }}>
            <Logo />
          </Box>
      ...
      {!isCollapse && (
        <Stack spacing={3} alignItems="flex-start" sx={{ px: 5, pb: 5, mt: 10, width: 1, textAlign: 'center' }}>
          ...
          <Button href={PATH_DOCS} target="_blank" color="inherit" variant="outlined">
            Support
          </Button>
        </Stack>
      )}

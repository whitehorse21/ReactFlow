...
const stripePromise = loadStripe(
  'pk_test_51JRNMVHZZ1uIMGYFuLyiMpHRb7is86RdNKcMOQUkIofOadOX6FMXKkRC3reaHxRBgIidmpwVDvbCFCpLeFSOY11e00Z6IPiBL4'
);
  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'elements', element: <DashboardHome showElements /> },
        { path: 'projects', element: <ProjectsMenu /> },
        /* ------------------------ previous ------------------------------- */
    ...
    },
    {
      ...
      element: <MainLayout />,
      children: [
        { path: '/', element: <Navigate to="/dashboard/home" replace /> }, // path: '/', element: <LandingPage /> ,
...
const ProjectsMenu = Loadable(lazy(() => import('../pages/dashboard/ProjectsMenu')));
/* -----------------------------------------------------------------*/
